...
assert(formatRankText(rank, rr, elo, user, 'en', '1') === 'Current Rank: Diamond 1', 'Rank EN Type 1');
assert(formatRankText(rank, rr, elo, user, 'en', '2') === 'Current Rank: Diamond 1 - 50 RR', 'Rank EN Type 2');
assert(formatRankText(rank, rr, elo, user, 'en', '3') === 'Current Rank: Diamond 1 - 50 RR (1500 ELO)', 'Rank EN Type 3');
...
const agent = 'Jett';
const mmrChange = 20;
assert(formatMatchText(map, isWin, kda, hs, agent, mmrChange, 'en', '1') === 'Last Match: Ascent - Win', 'Match EN Type 1');
assert(formatMatchText(map, isWin, kda, hs, agent, mmrChange, 'en', '2') === 'Last Match: Ascent - Win (10/5/5)', 'Match EN Type 2');
assert(formatMatchText(map, isWin, kda, hs, agent, mmrChange, 'en', '3') === 'Last Match: Ascent - Win (10/5/5 - 25.5% HS)', 'Match EN Type 3');
