...
assert(formatRankText(rank, rr, elo, user, 'en', '1') === 'Currently I am in Diamond 1', 'Rank EN Type 1');
assert(formatRankText(rank, rr, elo, user, 'en', '2') === 'Currently I am in Diamond 1 with 50 RR', 'Rank EN Type 2');
assert(formatRankText(rank, rr, elo, user, 'en', '3') === 'Currently I am in Diamond 1 with 50 RR, my mmr is 1500', 'Rank EN Type 3');
...
assert(formatMatchText(map, isWin, kda, hs, agent, mmrChange, 'en', '1') === 'My last match was on Ascent with Jett won 20 RR', 'Match EN Type 1');
assert(formatMatchText(map, isWin, kda, hs, agent, mmrChange, 'en', '2') === 'My last match was on Ascent with Jett won 20 RR my kda was 10/5/5', 'Match EN Type 2');
assert(formatMatchText(map, isWin, kda, hs, agent, mmrChange, 'en', '3') === 'My last match was on Ascent with Jett won 20 RR my kda was 10/5/5, my HS percentage was 25.5%', 'Match EN Type 3');
